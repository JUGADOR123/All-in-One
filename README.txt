Items:
	...
	inraidmodding 		true/false			allows to fully strip weapons midraid (currently not working)
...
player:
	...
	skillfatigue		true/false			if false skill fatigue is removed
	maxstamina			(any number)		default value: 100, if below 100, that number becomes max stamina, if above 100, infinite stamina
	
gameplay:
	globallootmodifier	(any number)		multiplier of loot (values too high will get you stuck on local game starting)
